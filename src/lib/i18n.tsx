...
export const STR = {
  en: {
    ...
    categories: "Product categories", prevPage: "Previous page", nextPage: "Next page",
    holeEmpty: "Hole {n}, empty", holeUp: "Hole {n}, snack is up — tap it", timeLeft: "Time left",
    addToCart: "Add {x} to cart", addOneMore: "Add one more {x}", removeOneOf: "Remove one {x}",
    soldOutOf: "{x}, sold out", searchLabel: "Search products", productList: "Product menu",
  ...
  my: {
    ...
    categories: "ပစ္စည်း အမျိုးအစားများ", prevPage: "ယခင် စာမျက်နှာ", nextPage: "နောက် စာမျက်နှာ",
    holeEmpty: "တွင်း {n}၊ ဗလာ", holeUp: "တွင်း {n}၊ မုန့်ပေါ်နေသည် — နှိပ်ပါ", timeLeft: "ကျန်ချိန်",
    addToCart: "{x} ကို စျေးခြင်းထဲ ထည့်ရန်", addOneMore: "{x} တစ်ခု ထပ်ထည့်ရန်", removeOneOf: "{x} တစ်ခု လျှော့ရန်",
    soldOutOf: "{x}၊ ကုန်သွားပြီ", searchLabel: "ပစ္စည်းများ ရှာရန်", productList: "ပစ္စည်း မီနူး",
